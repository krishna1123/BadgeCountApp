...
public class CubeWallpaper2 extends WallpaperService {
    ...
    class CubeEngine extends Engine
        ...
        private float nameX=100, nameY=100;
        private String text="Krishna";
        private int size=35;
...
// Create a Paint to draw the lines for our cube
            ...
            if(pref!=null){
                text=pref.getString("name", "Krishna");
                if(text==null || text.trim().length()==0){
                    text="Krishna";
                }

                size=pref.getInt("size", 35);
            }
...
// draw something
        ...
        void drawCube(Canvas c) {
            ...
            drawLines(c);
            c.drawText(text, nameX, nameY, namePaint);
            c.restore();
        }
...
// 3D-to-2D projection
        ...
        void drawTouchPoint(Canvas c) {
            if (mTouchX >= 0 && mTouchY >= 0) {
                ...
                nameX=mTouchX-240-80;
                nameY=mTouchY-240-80;
            }
        }
    }
}